                ...
                <div class="card-body">
                    <form action="{{ route('services.update', $service->id) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror rounded-5" name="title" id="example1" value="{{ $service->title }}">
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control @error('description') is-invalid @enderror rounded-4" name="description" id="example2">{{ $service->description }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('icon') is-invalid @enderror rounded-5" name="icon" id="example1" value="{{ $service->icon }}">
                            @error('icon')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
